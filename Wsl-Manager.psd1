...
@{
    ...
    FunctionsToExport = @("Install-Wsl", "Uninstall-Wsl", "Export-Wsl", "Get-WslRootFS", "Get-Wsl", "Invoke-Wsl", "New-WslRootFileSystem", "Get-WslRootFileSystem", "Sync-WslRootFileSystem")
