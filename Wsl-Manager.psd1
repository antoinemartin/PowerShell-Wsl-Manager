...
@{
    ...
    FunctionsToExport = @("New-WslInstance", "Remove-WslInstance", "Export-WslInstance", "Get-WslInstance", "Invoke-WslInstance", "Invoke-WslConfigure", "New-WslImage", "Get-WslImage", "Sync-WslImage", "Remove-WslImage", "Set-WslImageProperty", "Get-WslImageSource", "Update-WslBuiltinImageCache", "New-WslImageSource", "Update-WslImageSource", "Remove-WslImageSource", "Save-WslImageSource", "Rename-WslInstance", "Stop-WslInstance", "Set-WslDefaultUid", "Set-WslDefaultInstance")
    ...
    AliasesToExport   = @('Get-Wsl', 'gwsl', 'New-Wsl', 'nwsl', 'Remove-Wsl', 'rmwsl', 'Stop-Wsl', 'swsl', 'Invoke-Wsl', 'Rename-Wsl', 'mvwsl', 'cwsl', 'iwsl', 'Export-Wsl', 'ewsl', 'dwsl', 'gwsli', 'nwsli', 'rmwsli', "swsli", "gwsls", "uwsls", "swsls", "nwsls", "rmwsls", "swslip")
